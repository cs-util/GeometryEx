...
namespace GeometryEx
{
    ...
    */
    ...
    public static class ConvexHull
    {
        ...
        public static List<Vector3> MakeHull(IList<Vector3> points)
        {
            ...
            newPoints.Sort();
            var hullPoints = MakeHullPresorted(newPoints);
        ...
        private static IList<Point> MakeHullPresorted(IList<Point> points)
        {
            if (points.Count <= 1)
